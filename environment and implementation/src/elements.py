...
class Text:
    def __init__(self, x, y, text, text_size):
        """
            ...
            Args:
                x (int): X coordinate of the text displayed
                y (int): Y coordinate of the text displayed
    ...
    def draw(self, screen):
        ...
        self.render_surface = font.render(self.text, True, WHITE)
        self.x = self.x - self.render_surface.get_width() // 2
        self.y = self.y - self.render_surface.get_height() // 2
        screen.blit(self.render_surface, (self.x, self.y))
